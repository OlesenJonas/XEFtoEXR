...
namespace libfreenect2
{
    ...
    class Frame
    {
      public:
        ...
        enum Type
        {
            ...
            Depth = 4  ///< 512x424 float, unit: millimeter. Non-positive, NaN, and infinity are invalid or missing
                       ///< data.
        };
    ...
    class FrameListener
    {
      public:
         ...
         * @return true if you want to take ownership of the frame, i.e. reuse/delete it. Will be reused/deleted by
         * caller otherwise.
         */

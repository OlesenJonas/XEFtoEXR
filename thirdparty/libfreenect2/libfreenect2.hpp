...
namespace libfreenect2
{
    ...
    class Freenect2Device
    {
      public:
         ...
         * Kinect v2 includes factory preset values for these parameters. They are used in depth image decoding,
         * and Registration.
         */
    ...
    class Freenect2Replay
    {
      public:
         ...
         */
        // Freenect2Device*
        // openDevice(const std::vector<std::string>& frame_filenames, const PacketPipeline* factory);
